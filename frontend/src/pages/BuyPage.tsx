...
const BuyPage: React.FC = () => {
  ...
  const getLabelStyle = ({ width = '90px' }: { width?: string }) => ({
    display: 'flex',
    alignItems: 'center',
    width: width,
    minWidth: width,
  ...
  return (
    <div>
      <div style={{ width: '90%' }}>
        ...
        <div style={{ display: 'inline-flex', width: '100%', marginBottom: '10px', justifyContent: 'space-between', overflowX: 'scroll', paddingBottom: '8px' }}>
          {/* Percent */}
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <div style={getLabelStyle({'width': '130px'})}>
      ...
      <div style={{ position: 'fixed', bottom: '20px', right: '20px' }}>
        <div style={{ display: 'flex', justifyContent: 'flex-end', backgroundColor: 'rgb(248, 248, 248)', boxShadow: '0px 0px 4px 0px rgba(0,0,0,0.25)', padding: '10px', borderRadius: '5px' }}>
          <Button onClick={handleCancelClick} variant="outlined" style={{ opacity: 1 }}>Cancel</Button>
          <Button
